				...
				btnCrear.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(mode == 0) {
							...
							if(mode == 1) {
								if(aux != null) {
									int option = JOptionPane.showConfirmDialog(null, "Está seguro que desea modificar la información de este plan?", "Confirmación", JOptionPane.OK_CANCEL_OPTION);
									...
									JOptionPane.showMessageDialog(null, "Hubo un error al tratar de modificar el plan", "Información", JOptionPane.ERROR_MESSAGE);
									dispose();
								}
